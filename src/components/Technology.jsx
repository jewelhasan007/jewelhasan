...
const Technology = () => {
    return (
        <div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 justify-items-center mt-10 p-5'>
                {
                tech.map((item) => (
...
const tech = [
    ...
    {id:7, "title":"Postgres","image": './postgre.png'},
]
