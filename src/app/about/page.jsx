...
<div className="tabs tabs-lift mt-5">
  ...
  <div className="tab-content bg-base-100 border-base-300 p-6"><MyStory></MyStory></div>
  ...
  <div className="tab-content bg-base-100 border-base-300 p-6"><Experience></Experience></div>
  ...
  <div className="tab-content bg-base-100 border-base-300 p-6"><Education></Education></div>
  <label className="tab">
    <input type="radio" name="my_tabs_4" />
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 me-2">
  ...
  <div className="tab-content bg-base-100 border-base-300 p-6"><Skill></Skill></div>
</div>
       </div>
    );
};
